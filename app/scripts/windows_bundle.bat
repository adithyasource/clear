@echo off
upx --ultra-brute src-tauri\target\release\clear.exe

if not exist ".\builds\" mkdir ".\builds\"
if not exist ".\builds\setup\" mkdir ".\builds\setup\"
if not exist ".\builds\portable\" mkdir ".\builds\portable\"

makensis "/XOutFile '..\builds\setup\clear v1.1.1 setup.exe'" scripts\installer.nsi
copy "src-tauri\target\release\clear.exe" "builds\portable\clear v1.1.1 portable.exe" 
echo ===----------------------------------------------------------------------------------------------------------------------------
